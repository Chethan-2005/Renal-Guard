...
interface ApiService {
    ...
    fun getPatients(@Body request: com.example.renalguard.DoctorEmailRequest): Call<List<PatientModel>>
    ...
    fun getDoctorAppointments(@Body request: com.example.renalguard.DoctorEmailRequest): Call<DoctorAppointmentsResponse>
